GM University AI Chatbot Platform

The GM University AI Chatbot Platform is a web-based application designed to provide students, visitors, and faculty with seamless access to essential information about GM University, Davanagere.

The platform delivers key details such as academic programs, admissions, placements, library resources, and contact information through an intuitive dashboard and AI-powered chatbot interface.

This project has been developed in collaboration with the Robotics and Animation team, with the objective of integrating the system into a robotic interface for enhanced on-campus interaction.
...
GM University is a multidisciplinary institution offering programs in engineering, management, commerce, and computer applications. This platform serves as a centralized and user-friendly system that enables users to efficiently explore important university information.
...
Placements – Placement support and career opportunities
...
Provide a unified platform for accessing university information
